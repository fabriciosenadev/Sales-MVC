...
namespace SalesWebMvc.Data
{
    ...
    {
        //registrar uma dependendia deste servico com dbContext
        ...
        public void Seed()
        {
            // testa se existe algum registro nas tabelas indicadas
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; //existe dados em alguma das tabelas indicadas
            }
            ...
            // adiciona os objetos no banco de dados
            _context.Department.AddRange(d1, d2, d3, d4); //adiciona varios objetos de uma ve só
